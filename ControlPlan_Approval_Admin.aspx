<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ControlPlan_Approval_Admin.aspx.cs" Inherits="ControlPlan_Approval_Admin" %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        <label for="ddlstatus"><i class="fa fa-check-circle"></i>&nbsp;Status</label>
                                ...
                                <div class="box-body">
                                    <asp:GridView runat="server" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MachineDesc" HeaderText="Machine" />
