<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="dcr_sop_qry.aspx.cs" Inherits="dcr_sop_qry" %>
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group has-success">
                                        <label for="ddlgroup"><i class="fa fa-check-circle"></i>&nbsp;Group </label>
                                        <asp:DropDownList runat="server" ID="ddlgroup" CssClass="form-control myselect" >
                                            <asp:ListItem Text="Select..." />
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvddlgroup" ErrorMessage="Data Missing!" ControlToValidate="ddlgroup" runat="server" InitialValue="Select..."
                                    ...
                                    <asp:GridView runat="server" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            <asp:HyperLinkField DataNavigateUrlFields="dcr_slno" HeaderText="DCR Number"
                                                DataNavigateUrlFormatString="~/dcr_sop.aspx?slno={0}"
                                                ItemStyle-Font-Underline="true" DataTextField="dcr_number" />
                                            <asp:BoundField DataField="Group_Name" HeaderText="Part Description" />
