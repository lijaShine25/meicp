...
[TableName("DCR_Status")]
[PrimaryKey("slno")]

/// <summary>
/// properties defined for customers
/// </summary>
public class Class_DCR_Status : IDisposable {
...
/// </summary>
public class Crud_DCR_Status : IDisposable
{
   public Crud_DCR_Status()
   {
       // 
   }
   ...
   public void Insert(Class_DCR_Status objName)
   {
       using (Database db = new Database("connString"))
       {
           db.Insert<Class_DCR_Status>(objName);
       }
   }
   ...
   /// </summary>
   /// <param name="objName">objName as Class_customers</param>
   public void Update(Class_DCR_Status objName)
   {
       using (Database db = new Database("connString"))
       {
           db.Update(objName);
   ...
   public void Delete(int id)
   {
       using (Database db = new Database("connString"))
       {
           db.DeleteWhere<Class_DCR_Status>("dcr_slno=@0", id);
       }
   }
   ...
   public List<Class_DCR_Status> SelectAll()
   {
       using (Database db = new Database("connString"))
       {
           return db.Fetch<Class_DCR_Status>();
       }
   }
   ...
   public Class_DCR_Status SelectOne(int id)
   {
       using (Database db = new Database("connString"))
       {
           return db.SingleOrDefaultById<Class_DCR_Status>(id);
       }
   }
