<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DCR_Approval_Admin.aspx.cs" Inherits="DCR_Approval_Admin" %>
                            ...
                            <div class="box-body">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="ddlpart_slno">Part</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlstatus" CssClass="form-control myselect">
                                            <asp:ListItem Text="Select..." />
                                            <asp:ListItem Text="Approved" Value="A" />
                                            <asp:ListItem Text="Not Approved" Value="Y" />
                                ...
                                <div class="box-body">
                                    <asp:GridView runat="server" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="DCR_Approved_DateTime" HeaderText="Approved DateTime" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" />
