<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="dcr_sop.aspx.cs" Inherits="dcr_sop" %>
    ...
    <form id="Form1" role="form" runat="server">
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Document Change Request - SOP
                </h1>
            </section>
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="col-sm-8 col-md-offset-4">
                                    <div class="pull-right">
                                        ...
                                        <asp:Button ID="btnQuery" Text="Query" runat="server" CssClass="btn btn-info" PostBackUrl="~/dcr_sop_qry.aspx" />
                                        <asp:Button ID="btnDelete" Text="Delete" runat="server" CssClass="btn btn-danger" OnClientClick="return confirmation();" OnClick="btnDelete_Click" Enabled="false" />
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            <label for="gruo"><i class="fa fa-check-circle"></i>&nbsp;Group</label>
                                            <asp:DropDownList runat="server" ID="ddlgroup" CssClass="form-control myselect" AutoPostBack="true" OnSelectedIndexChanged="ddlgroup_OnSelectedIndexChanged">
                                                <asp:ListItem Text="Select..." Value="0" />
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="rfvddlgroup" ErrorMessage="Data Missing!" ControlToValidate="ddlgroup" runat="server" InitialValue="0"
                                                CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group has-success">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlchangearea" CssClass="form-control">
                                                <asp:ListItem Text="Select..." Value="0" />
                                                <asp:ListItem Text="SOP" Value="SOP" Selected="true" />
        ...
        <asp:HiddenField runat="server" ID="hdnsubmitstatus"  Value="N"/>
