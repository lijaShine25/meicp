<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EvaluationTechnique.aspx.cs" Inherits="EvaluationTechnique" %>
...
<form id="Form1" role="form" runat="server">
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Evaluation Measurement Techniques
                </h1>
            </section>
                ...
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group has-success">
                                    <label for="txtEvalTech"><i class="fa fa-check-circle"></i>&nbsp;Evaluaion Technique</label>
                                    <asp:TextBox runat="server" ID="txtEvalTech" CssClass="form-control" Text="" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="Data Missing!" ControlToValidate="txtEvalTech" runat="server"
                    ...
                    <div class="col-md-5">
                        <div class="box box-info">
                            <div class="box-header">
                                <h3 class="box-title">List of Evaluation Techniques</h3>
                            </div>
                            <div class="box-body">
                                <asp:GridView runat="server" ClientIDMode="Static" 
                                    ...
                                    <Columns>
                                        <asp:HyperLinkField DataNavigateUrlFields="evalTech_slno" HeaderText="Evaluation Technique"
                                            DataNavigateUrlFormatString="~/EvaluationTechnique.aspx?slno={0}"
                                            ItemStyle-Font-Underline="true" DataTextField="evalTech" />
