                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox runat="server" ID="txtEmployeeName" CssClass="form-control" Text=""  />
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <asp:TextBox runat="server" ID="txtEmailId" CssClass="form-control" Text=""  />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="Data Missing!" ControlToValidate="txtEmailId" runat="server"
                                        CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                </div>
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Data Missing!" ControlToValidate="ddlCanPrepare" runat="server"
                                        CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                </div>
                                <div class="form-group has-success">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ErrorMessage="Data Missing!" ControlToValidate="ddlCanApprove" runat="server"
                                        CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                </div>
                                <div class="form-group has-success">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ErrorMessage="Data Missing!" ControlToValidate="ddlisAdmin" runat="server"
                                        CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                </div>
                                <div class="form-group has-success">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ErrorMessage="Data Missing!" ControlToValidate="ddlallmaster" runat="server"
                                        CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />
                                </div>
                                <div class="form-group">
                                    <label for="ddlkeycont">Control Plan Key Contact</label>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <label for="ddlActiveInactive">Active / In-Active</label>                                 
                                      ...
                                      <asp:RequiredFieldValidator ID="Rfd_AI" ErrorMessage="Data Missing!" ControlToValidate="ddlActiveInactive" runat="server" 
                                      CssClass="label label-danger" Display="Dynamic" ValidationGroup="mandatories" />    
